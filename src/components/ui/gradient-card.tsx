...
interface GradientCardProps {
  title?: string;
  description?: string;
  icon?: string; // Icon image name, e.g., "service-icon1.svg"
  href?: string;
  width?: string;
  height?: string;
}
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-center w-full h-full relative z-10">
              {icon ? (
                <img src={`/assets/images/${icon}`} alt="icon" className="w-5 h-5 object-contain filter invert" />
              ) : (
          ...
          >
            ...
            {/* Full-card link overlay making the entire card clickable */}
            {href && (
              <Link
                to={href}
